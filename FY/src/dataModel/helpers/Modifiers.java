...
public final class Modifiers {
	...
	//network
	private final double asn = 0.2;
	private final double contrry = 0.3;
	private final double Useragegent = 0.5;
	...
	// final cal
	private final double ip = 0.1;
	private final double db = 0.90;
	/**
